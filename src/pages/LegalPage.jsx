    ...
    <Layout currentPage="" renderHeader={false} renderFooter={false}>
      <div className="bg-[#f8f5ee] text-[#131b2e]">
        ...
        <section className="relative isolate overflow-hidden bg-[#0d0d0b] text-white">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 pb-20 pt-36 sm:px-6 lg:px-8 lg:pb-24 lg:pt-44">
            ...
            <div className="mt-6 max-w-4xl">
              ...
              <p className="mt-6 max-w-3xl text-lg leading-8 text-white/90 sm:text-xl sm:leading-9">{legalDoc.description}</p>
              ...
              return (
                <AppLink
                  ...
                  className={`px-4 py-2 text-xs font-semibold uppercase tracking-[0.18em] transition ${
                    active ? "bg-black text-white" : "border border-black/10 bg-[#f8f5ee] text-slate-700 hover:bg-black hover:text-white"
                  }`}
                >
                  {item.label}
                </AppLink>
        ...
        <section className="border-t border-black/10 bg-white py-20">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="border-t-2 border-black bg-[#f8f5ee] p-8 md:p-10">
