export const HERO_BLURBS = [
  "Flores' tri-colored lakes glow at sunrise and stay quiet after the crowds move on.",
  "Raja Ampat is a scatter of emerald islets with bright reefs and glassy lagoons.",
];

export const VALUE_PROPS = [
  { title: "Local planners", copy: "Bali-based team that holds boats, drivers, and backups before you land." },
  { title: "Clear pricing", copy: "Routes with budgets and options upfront so you can confirm fast." },
  { title: "24/7 support", copy: "One WhatsApp thread with the planner and on-trip fixer the whole time." },
];
...
export const RECOMMENDATIONS = [
  ...
  },
  {
    id: "besakih-bali",
    title: "2nd place",
    location: "Pura Luhur Besakih, Bali",
    duration: "6 days",
    price: "from $1,680",
